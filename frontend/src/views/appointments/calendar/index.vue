          ...
          <div class="vehicle-info-card">
            <div class="vehicle-image">
              <img
                :src="
                  vehicle.image ||
                  'https://via.placeholder.com/400x250?text=AutoSphere'
                "
                :alt="vehicle.name"
              />
            </div>
            <div class="vehicle-details">
              ...
              <div class="vehicle-specs">
                ...
                <div class="spec-item">
                  ...
                  <span class="spec-value">{{
                    vehicle.location || 'Ciudad de México'
                  }}</span>
                </div>
              </div>
          ...
          <div class="form-card">
            <div class="form-header">
              ...
              <p class="form-subtitle">
                Complete el siguiente formulario para agendar una cita y conocer
            ...
            <form class="appointment-form" @submit.prevent="submitAppointment">
              ...
              <div class="form-section">
                <h2 class="section-title">Vehículo seleccionado</h2>
      ...
      >
        <div class="modal-success">
          ...
          <p>
            ...
            en las próximas 24 horas para confirmar los detalles de tu cita.
          </p>
          <div class="appointment-summary">
            <p>
              <strong>Vehículo:</strong> {{ vehicle.name }} {{ vehicle.year }}
            </p>
            <p>
          ...
          <div class="modal-buttons">
            ...
            <button class="btn-view-vehicles" @click="goToVehicles">
              Ver más vehículos
            </button>
          </div>
        </div>
