    ...
    <div class="content-area">
      ...
      <div class="price-card">
        <div class="price-header">
          <div>
            ...
            <h2 class="price-value">${{ formatPrice(vehicle.price) }} <span class="price-currency">MXN</span></h2>
            <p class="price-financing" v-if="monthlyPayment">
      ...
      <div class="details-panel" :class="{ open: showDetails }">
        ...
        <div class="info-section">
          ...
          <div class="info-grid">
            <div class="info-item" v-for="item in vehicleInfoItems" :key="item.label">
        ...
        <div class="info-section">
          ...
          <div class="features-grid">
            <div class="feature-item" v-for="feature in vehicleFeatures" :key="feature">
          ...
          <div class="seller-content">
            ...
            <div class="seller-info">
              ...
              <div class="seller-rating">
                ...
                <span>{{ sellerRating }} • {{ vehicle.sellerProfile?.responseTime || 'Respuesta rápida' }}</span>
              </div>
...
// DEFAULT DATA
const defaultDescription = 'Vehículo en excelente condición, mantenimiento al día. Ideal para ciudad y carretera.'
const defaultFeatures = ['Aire acondicionado', 'Dirección hidráulica', 'Vidrios eléctricos', 'Bluetooth', 'Sistema de audio']
...
const vehiclesDatabase = ref([
  {
    ...
    cylinders: 4,
    doors: 5,
    description: 'Mazda CX-5 i Grand Touring 2021, SUV compacta premium. Equipamiento completo, único dueño, servicios en agencia.',
    features: ['Asientos de piel', 'Pantalla táctil', 'Cámara de reversa', 'Sensores de estacionamiento', 'Control crucero', 'Bluetooth'],
    gallery: [
  ...
  },
  {
    ...
    cylinders: 4,
    doors: 4,
    description: 'Toyota Corolla LE 2020, sedán confiable y económico. Excelente rendimiento de combustible y mantenimiento reciente.',
    features: ['Frenos ABS', 'Airbags', 'Aire acondicionado', 'Dirección eléctrica', 'Radio AM/FM', 'USB'],
    gallery: [
  ...
  },
  {
    ...
    cylinders: 4,
    doors: 4,
    description: 'Ford Ranger XLT 2022, pickup robusta y potente. Ideal para trabajo y aventura. Impecable estado.',
    features: ['Tracción 4x4', 'Caja de carga', 'Control de tracción', 'Pantalla 8"', 'Sistema SYNC', 'Asistente de pendiente'],
    gallery: [
...
const thumbnailImages = computed(() => vehicle.value?.gallery || [vehicle.value?.coverImage])
...
const vehicleFeatures = computed(() => vehicle.value?.features || defaultFeatures)
...
const sellerName = computed(() => vehicle.value?.sellerProfile?.displayName || 'AutoSphere Certified')
const sellerRating = computed(() => vehicle.value?.sellerProfile?.rating || 4.8)
const sellerVerified = computed(() => vehicle.value?.sellerProfile?.verified !== false)
