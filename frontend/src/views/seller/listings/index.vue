          ...
          >
            ...
            <div class="listing-left">
              <div class="vehicle-icon">
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M5 17H4C3.46957 17 2.96086 16.7893 2.58579 16.4142C2.21071 16.0391 2 15.5304 2 15V9.5C2 8.96957 2.21071 8.46086 2.58579 8.08579C2.96086 7.71071 3.46957 7.5 4 7.5H6.5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  <circle cx="7" cy="17" r="2" stroke="currentColor" stroke-width="2"/>
                  <circle cx="17" cy="17" r="2" stroke="currentColor" stroke-width="2"/>
                  <path d="M22 12V13C22 13.5304 21.7893 14.0391 21.4142 14.4142C21.0391 14.7893 20.5304 15 20 15H19M9 17H15" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M6.5 7.5V4H17.5L22 9.5V12H6.5V7.5Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </div>
            ...
            <div class="listing-actions">
              <button class="action-btn btn-edit" @click="editListing(listing.id)">
                Editar
              </button>
              <button class="action-btn btn-view" @click="viewAsPublic(listing.id)">
                Ver como público
              </button>
              <button class="action-btn btn-delete" @click="deleteListing(listing.id)">
                Eliminar
              </button>
            </div>
          </div>
