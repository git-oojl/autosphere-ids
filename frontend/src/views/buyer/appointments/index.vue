<template>
  <section class="appointments-page">
    <header class="hero">
      ...
      <h1>Mis citas</h1>
      <p>
        Listado completo para revisar estado, abrir detalle y volver al catálogo
    ...
    <div v-if="appointments.length" class="list-grid">
      ...
      >
        ...
        <div class="actions">
          ...
          <button class="secondary" @click="openListing(appointment.listingId)">
            Ver vehículo
          </button>
        </div>
      </article>
    ...
    <div v-else class="card empty-state">
      ...
      <p>
        Explora el catálogo y agenda una revisión o prueba de manejo desde el
