<template>
  <div class="register-container">
    ...
    <div class="register-card">
      ...
      <p class="register-subtitle">Únete a la comunidad de autos de lujo</p>
      ...
      <form @submit.prevent="handleRegister" class="register-form">
        ...
        <div class="form-group">
          <label for="phone" class="form-label">
            <span class="label-icon">
              <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M22 16.92V19.92C22 20.4728 21.5523 20.92 21 20.92H18C8.61116 20.92 1 13.3088 1 3.92C1 3.36772 1.44772 2.92 2 2.92H5C5.55228 2.92 6 3.36772 6 3.92V7.42C6 7.97228 5.55228 8.42 5 8.42H3.5C4.5 13.92 9.5 18.92 15 19.92V18.42C15 17.8677 15.4477 17.42 16 17.42H19.5C20.0523 17.42 20.5 17.8677 20.5 18.42V19.92" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
            </span>
            Teléfono:
          </label>
          ...
          <div class="role-selection">
            ...
            >
              ...
              <div class="role-card">
                <div class="role-icon">
                  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9 2L11 6L15 7L12 10L13 14L9 12L5 14L6 10L3 7L7 6L9 2Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>
                </div>
        ...
        <div class="form-options">
          <label class="terms-checkbox">
            ...
            <span class="checkbox-label">
              Acepto los 
              <a href="#" @click.prevent="showTerms" class="link-text">términos y condiciones</a>
            </span>
          </label>
        </div>
...
watch(() => formData.confirmPassword, (newValue) => {
  if (newValue && formData.password !== newValue) {
